...
@Component({
    selector: 'app-handsontable-index-component',
    templateUrl: './handsontable.index.component.html'
})
export class HandsontableIndexComponent implements OnInit {
    ...
    getOptions2() {
        let colHeaders: Array<string> = ['year', 'num1', 'num2', 'num3', 'num4'];
    ...
    getOptions3() {
        ...
        const currencyCodes = ['EUR', 'JPY', 'GBP', 'CHF', 'CAD', 'AUD', 'NZD', 'SEK', 'NOK', 'BRL', 'CNY', 'RUB', 'INR', 'TRY', 'THB', 'IDR', 'MYR', 'MXN', 'ARS', 'DKK', 'ILS', 'PHP'];

        let flagRenderer = (instance, td, row, col, prop, value, cellProperties) => {
            // 清空自身
            while (td.firstChild) {
            ...
            valueHTML.style.color = 'red';
            valueHTML.innerHTML = value;

            td.appendChild(valueHTML);
        };
        ...
        return {
            ...
            outsideClickDeselects: false // 外部点击不让选中失效
        }
    }
